...
* $\varepsilon_i \overset{\text{iid}}{\sim} N\left(0,\sigma ^2 \right), \quad i = 1, 2, \ldots, n$, los errores idéntica e independientemente distribuidos normal con media cero y varianza constante.

...
En este contexto, las variables predictoras a menudo están interrelacionadas  entre sí (no son independientes una de otras), lo que puede generar dificultades al intentar determinar la contribución individual de cada variable en la explicación de la variable de respuesta. 
